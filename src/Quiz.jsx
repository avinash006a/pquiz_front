...
const Quiz = () => {
  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        const response = await axios.get(`http://192.168.255.4:3002/api/questions/${setNumber}/random`);
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post("http://192.168.255.4:3002/api/scores/sc", {
        userId,
        setNumber,
